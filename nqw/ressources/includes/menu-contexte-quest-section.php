						<div class="menuDeroul">
							...
							<ul>
								...
								<li><a href="#" onclick="supprimerItem('<?php echo TXT_VOULEZ_VOUS_SUPPRIMER_CETTE_SECTION ?>','<?php echo $quest->get("id_questionnaire") ?>','<?php echo $item->get("id_item") ?>')"><?php echo TXT_SUPPRIMER_CETTE_SECTION_ET_SON_CONTENU ?></a></li>
