										...
										<div class="detailContenu">
											...
											<div class="itemType">
												...
												<div class="menuContexteGa displayInline">
													<a class="tools" href="#"><span class="txtType"><img class="alTexBot" src="../images/ic-zone-identifier.png" alt="<?php echo TXT_ZONES_A_IDENTIFIER ?>" />&nbsp;<?php echo TXT_ZONES_A_IDENTIFIER ?><img src="../images/ic-tools-2.png" alt="" /></span></a>
											...
											<div class="padBot5">
                                            	<p class="padBot0"><label for="item_couleur_zones"><?php echo TXT_CONTOUR_DES_ZONES_SUR_IMAGE_WEB ?></label></p>
									
								 				<?php $couleur = "zones" ?>
												<div class="menuContexte menuContexteCouleurs displayInline" >
													<input type="hidden" name="item_couleur_zones" id="item_couleur_zones" value="<?php echo $item->get("couleur_zones")?>" />
													<a class="tools gras" href="#item_couleur_zones"><span class="carre" style="background: #<?php if ($item->get("couleur_zones") == "") echo "000000"; else echo $item->get("couleur_zones")?>;" id="couleur_zones"></span></a>
													<?php include '../ressources/includes/menu-contexte-couleurs-zones-identifier.php' ?>
												</div>
												
											</div>											
											
											<div>
                                            	<p class="padBot0"><label for="item_image"><?php echo TXT_IMAGE ?></label></p>
												<div class="zonesImage">

													<div id="item_image_selection">
                                                        <input type="hidden" id="item_image" name="item_image" value="<?php echo $item->get("image") ?>" />
														<?php if ($item->get("image") == 0) { 
                                                            $libelle = "image";
                                                        ?>
                                                            <!--  Afficher le menu de selection d'une image -->
                                                            <div class="menuContexte displayInline">

																<div id="item_image_lien">
                                                        ...
                                                        ?> 
                                                            ...
                                                            <!--  Afficher l'image -->
                                                            <div id="item_image_affichage">
                                                            <p class="elementImage">
                                                                <a href="media.php?demande=media_presenter&media_id_media=<?php echo $img ?>" target="media_<?php echo $img ?>" title="<?php echo TXT_PREFIX_MEDIA . $img ?>">
                                                                    <img id="image_zone" class="containerDraggable" src="media.php?demande=media_afficher&media_id_media=<?php echo $img ?>" alt="<?php echo TXT_PREFIX_MEDIA . $img ?>" />
                                                                </a>
    
                                                                <span class="icBtnDel" id="item_image_supp" <?php if ($img == 0) { ?> style="display: none;" <?php } ?>>
                                                                    <a href="#" onclick="viderChampImage('item_image')"><img class="icDelete" src="../images/ic-delete.png" alt="" /></a>
                                                                </span>
                                                            </p>
                                                            </div>
                                                            <!-- / Afficher l'image -->
											...
											<div id="listeZones" class="containerDraggable">
											
											<?php 	
													for ($i = 1; $i <= NB_MAX_CHOIX_REPONSES; $i++) { 
														if ($item->get("reponse_" . $i . "_statut") == "1" ) {	?>
												
															<div class="zonesZone zoneBordure<?php echo $item->get("couleur_zones")?>" id="item_reponse_<?php echo $i ?>"><?php echo $i ?></div>
													
											<?php 		}
													}?>
											</div>
												
											<table class="tblItemDesc" id="liste-elements">
												<tr class="titre">
													<td>&nbsp;</td>
													<td><label class="displayInline"><?php echo TXT_ZONES_A_IDENTIFIER_ENTETE_ITEM ?> :</label> 
														<div class="menuContexte displayInline">
												...
												<?php for ($i = 1; $i <= NB_MAX_CHOIX_REPONSES; $i++) { 
													...
													<tr class="item_choix_mult" id="element<?php echo $i ?>">
														<td rowspan="2" style="width:2%;"><p class="id-element ocre gras"><?php echo $i ?></p></td>
																											
													<?php if ($item->get("type_elements1") != "image") { ?>
														<td rowspan="2" style="width:48%;"><textarea id="reponse_<?php echo $i ?>_element" class="wmax element-texte editeur suiviModif" name="item_reponse_<?php echo $i ?>_element" rows="6" cols="200"><?php echo $item->get("reponse_" . $i . "_element") ?></textarea></td>
													<?php } ?>
													...
													<?php } ?>
														...
														<td class="noPadBot" style="min-width:48%;"><textarea id="reponse_<?php echo $i ?>_retroaction" class="wmax element-retro editeur suiviModif" name="item_reponse_<?php echo $i ?>_retroaction" rows="2" cols="200" placeholder="<?php echo TXT_INSCRIRE_VOTRE_RETROACTION_POSITIVE ?>"><?php echo $item->get("reponse_" . $i . "_retroaction") ?></textarea></td>
													...
													<tr>
														<td><textarea id="reponse_<?php echo $i ?>_retroaction_negative" class="wmax element-retro editeur suiviModif" name="item_reponse_<?php echo $i ?>_retroaction_negative" rows="2" cols="200" placeholder="<?php echo TXT_INSCRIRE_VOTRE_RETROACTION_NEGATIVE ?>"><?php echo $item->get("reponse_" . $i . "_retroaction_negative") ?></textarea></td>
														<td></td>
													</tr>
													...
													<tr>
													  	<td></td>
													  	<td colspan="3">
													  	  <?php echo TXT_COORDONNEE_X ?> : <input type="text" name="item_reponse_<?php echo $i ?>_coordonnee_x" id="item_reponse_<?php echo $i ?>_coordonnee_x" value="<?php echo $item->get("reponse_" . $i . "_coordonnee_x") ?>" /> 
													  	  <?php echo TXT_COORDONNEE_Y ?> : <input type="text" name="item_reponse_<?php echo $i ?>_coordonnee_y" id="item_reponse_<?php echo $i ?>_coordonnee_y" value="<?php echo $item->get("reponse_" . $i . "_coordonnee_y") ?>" />
													  	</td>
													  </tr>
