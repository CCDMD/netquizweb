						<div class="menuDeroul">
							<p class="menuTitre"><?php echo $quest->get("titre_menu") ?> : <?php echo TXT_PAGE_ACCUEIL ?></p>
							<ul>
								<li><a href="questionnaires.php?demande=questionnaire_apercu&questionnaire_id_questionnaire=<?php echo $quest->get("id_questionnaire")?>&demandeRetour=accueil_modifier"><?php echo TXT_VOIR_APERCU_WEB ?></a></li>
								<li><a href="#" onclick="soumettreDemandeApercu('questionnaire_accueil_imprimer')"><?php echo TXT_IMPRIMER ?>...</a></li>
								<li class="section"></li>
