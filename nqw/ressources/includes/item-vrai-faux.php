										...
										<div class="detailContenu">
											...
											<div class="itemType">
												...
												<div class="menuContexteGa displayInline">
													<a class="tools" href="#"><span class="txtType"><img class="alTexBot" src="../images/ic-vrai-faux.png" alt="<?php echo TXT_VRAI_OU_FAUX ?>" />&nbsp;<?php echo TXT_VRAI_OU_FAUX ?><img src="../images/ic-tools-2.png" alt="" /></span></a>
											...
											<table class="tblItemDesc margTop20" id="liste-elements">
												<tr class="titre">
													...
													<td><label class="displayInline"><?php echo TXT_REPONSE ?></label> </td>
													<td><label><?php echo TXT_RETROACTION ?></label></td>
												</tr>
												<tr>
													<td style="width:2%;"><p class="id-element ocre gras">1</p></td>
													<td><input type="radio" name="item_reponse_choix" value="1" <?php if ($item->get("reponse_choix") == "1") echo "checked='checked'" ?> onclick="fermerEditeurs()" /></td>
													<td><textarea class="wmax element-texte editeur suiviModif" name="item_reponse_1_element" rows="4" cols="200" onclick="fermerEditeurs()"><?php echo $item->get("reponse_1_element") ?></textarea></td>
													<td><textarea class="wmax element-retro editeur suiviModif" name="item_reponse_1_retroaction" rows="4" cols="200" placeholder="<?php echo TXT_INSCRIRE_VOTRE_RETROACTION ?>" onclick="fermerEditeurs()"><?php echo $item->get("reponse_1_retroaction") ?></textarea></td>
												</tr>
												<tr>
													<td style="width:2%;"><p class="id-element ocre gras">2</p></td>
													<td><input type="radio" name="item_reponse_choix" value="2" <?php if ($item->get("reponse_choix") == "2") echo "checked='checked'" ?> onclick="fermerEditeurs()" /></td>
													<td><textarea class="wmax element-texte editeur suiviModif" name="item_reponse_2_element" rows="4" cols="200" onclick="fermerEditeurs()"><?php echo $item->get("reponse_2_element") ?></textarea></td>
													<td><textarea class="wmax element-retro editeur suiviModif" name="item_reponse_2_retroaction" rows="4" cols="200" placeholder="<?php echo TXT_INSCRIRE_VOTRE_RETROACTION ?>" onclick="fermerEditeurs()"><?php echo $item->get("reponse_2_retroaction") ?></textarea></td>
												</tr>
											</table>
										</div>						
									</div>
