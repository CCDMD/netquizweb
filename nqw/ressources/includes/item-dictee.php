										...
										<div class="detailContenu">
											...
											<div class="itemType">
												...
												<div class="menuContexteGa displayInline">
													<a class="tools" href="#"><span class="txtType"><img class="alTexBot" src="../images/ic-dictee.png" alt="<?php echo TXT_DICTEE ?>" />&nbsp;<?php echo TXT_DICTEE ?><img src="../images/ic-tools-2.png" alt="" /></span></a>
											...
											<p><label for="item_solution_dictee"><?php echo TXT_SOLUTION_DICTEE ?></label>
												<textarea class="wmax suiviModif" id="item_solution" name="item_solution" rows="4" cols="200" ><?php echo $item->get("solution") ?></textarea></p>
											
											<div class="wmax100 clear padTo15"><hr /></div>
											
											<p><label for=""><?php echo TXT_RETROACTIONS_GLOBALES ?></label>
												<?php echo TXT_RETROACTION_POSITIVE ?>
												<textarea class="wmax editeur suiviModif" id="item_retroaction_positive" name="item_retroaction_positive" rows="4" cols="200" placeholder="<?php echo TXT_INSCRIRE_VOTRE_RETROACTION?>"><?php echo $item->get("retroaction_positive") ?></textarea></p>
											<p><?php echo TXT_RETROACTION_NEGATIVE ?>
												<textarea class="wmax editeur suiviModif" id="item_retroaction_negative" name="item_retroaction_negative" rows="4" cols="200" placeholder="<?php echo TXT_INSCRIRE_VOTRE_RETROACTION?>"><?php echo $item->get("retroaction_negative") ?></textarea></p>
									...
									<div id="section3" class="detailContenant nod">
										<div class="detailContenu">
											...
											<div class="wdemiGa">
												...
												<p><label for="item_points_retranches"><?php echo TXT_POINTS_RETRANCHES_MOT_MAL_ORTHOGRAPHIES ?></label>
