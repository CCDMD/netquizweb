						<div class="menuDeroul">
							...
							<ul>
								<li><a href="questionnaires.php?demande=item_dupliquer&questionnaire_id_questionnaire=<?php echo $quest->get("id_questionnaire") ?>&item_id_item=<?php echo $item->get("id_item")?>"><?php echo TXT_DUPLIQUER ?></a></li>
								...
								<li><a href="#" onclick="supprimerItem('<?php echo TXT_VOULEZ_VOUS_SUPPRIMER_CET_ITEM_DU_QUESTIONNAIRE ?>','<?php echo $quest->get("id_questionnaire") ?>','<?php echo $item->get("id_item") ?>')"><?php echo TXT_SUPPRIMER_ITEM_DU_QUESTIONNAIRE ?></a></li>
