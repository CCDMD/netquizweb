										...
										<div class="detailContenu">
											...
											<div class="itemType">
												...
												<div class="menuContexteGa displayInline">
													<a class="tools" href="#"><span class="txtType"><img class="alTexBot" src="../images/ic-choix-multiples.png" alt="<?php echo TXT_CHOIX_MULTIPLES ?>" />&nbsp;<?php echo TXT_CHOIX_MULTIPLES ?><img src="../images/ic-tools-2.png" alt="" /></span></a>
												...
												<?php for ($i = 1; $i < NB_MAX_CHOIX_REPONSES; $i++) { 
													...
													<tr class="item_choix_mult" id="element<?php echo $i ?>">
														...
														<td>
															...
															<input type="radio" name="item_reponse_choix" class="suiviModif" value="<?php echo $i ?>" <?php if ($item->get("reponse_choix") == $i) echo "checked='checked'" ?>  onclick="fermerEditeurs()" />
														</td>
														
													<?php if ($item->get("type_elements1") != "image") { ?>
														<td><textarea id="reponse_<?php echo $i ?>_element" class="wmax element-texte editeur suiviModif" name="item_reponse_<?php echo $i ?>_element" rows="4" cols="200" placeholder="<?php echo TXT_INSCRIRE_VOTRE_TEXTE ?>"><?php echo $item->get("reponse_" . $i . "_element") ?></textarea></td>
													<?php } ?>
													...
													<?php } ?>
														...
														<td><textarea id="reponse_<?php echo $i ?>_retroaction" class="wmax element-retro editeur suiviModif" name="item_reponse_<?php echo $i ?>_retroaction" rows="4" cols="200" placeholder="<?php echo TXT_INSCRIRE_VOTRE_RETROACTION ?>"><?php echo $item->get("reponse_" . $i . "_retroaction") ?></textarea></td>
														<td class="icDelAdd">
