										...
										<div class="detailContenu">
											...
											<div class="itemType">
												...
												<div class="menuContexteGa displayInline">
													<a class="tools" href="#"><span class="txtType"><img class="alTexBot" src="../images/ic-damier.png" alt="<?php echo TXT_DAMIER ?>" />&nbsp;<?php echo TXT_DAMIER ?><img src="../images/ic-tools-2.png" alt="" /></span></a>
											...
											<table class="tblItemDesc margTop20" id="liste-elements">
												<tr class="titre">
													<td>&nbsp;</td>
													<td class="nowrap"><label class="displayInline txtMajus"><?php echo TXT_ELEMENT ?> :</label> 
													...
													<td class="nowrap"><label class="displayInline"><?php echo TXT_ELEMENT_ASSOCIE ?> :</label> 
														<div class="menuContexte displayInline">
													...
													<td><label><?php echo TXT_MASQUE ?></label></td>
												...
												<?php for ($i = 1; $i < NB_MAX_CHOIX_REPONSES; $i++) { 
													...
													<?php if ($item->get("type_elements1") != "image") { ?>
														<td style="width:30%;"><textarea id="reponse_<?php echo $i ?>_element" class="wmax element-texte editeur suiviModif" name="item_reponse_<?php echo $i ?>_element" rows="4" cols="200"><?php echo $item->get("reponse_" . $i . "_element") ?></textarea></td>
													<?php } ?>
													...
													<?php if ($item->get("type_elements2") != "image") { ?>
														<td style="width:30%;"><textarea id="reponse_<?php echo $i ?>_element_associe" class="wmax element-texte editeur suiviModif" name="item_reponse_<?php echo $i ?>_element_associe" rows="4" cols="200"><?php echo $item->get("reponse_" . $i . "_element_associe") ?></textarea></td>
													<?php } ?>
																...
																<?php } else {
																	...
																	<div id="item_<?php echo $libelle ?>_affichage">
																		<p class="elementImage">
																			...
																			<span id="item_<?php echo $libelle ?>_supp" <?php if ($img == 0) { ?> style="display: none;" <?php } ?>>
																				<a class="icBtnDel" href="#" onclick="viderChampImage('item_<?php echo $libelle ?>')"><img class="icDelete" src="../images/ic-delete.png" alt="" /></a>
																			</span>
																		</p>
																	</div>
																	<!-- / Afficher l'image -->
													...
													<?php } ?>
														...
														<td>
																 ...
																 ?>
																	...
																	<?php if ($img == "0") { ?>
																	<!--  Masque par défaut -->																	
																		<p class="damierMasque">

																			<img class="itemMediaImg" src="<?php echo IMAGE_PAIR_URL ?>" alt="" />
																			
																			<span class="icBtnDel" id="item_<?php echo $libelle ?>_supp">
																				<a href="#" onclick="viderChampImage('item_<?php echo $libelle ?>')"><img class="icDelete" src="../images/ic-delete.png" alt="" /></a>
																			</span>
																		</p>
														...
														<td style="min-width:30%;"><textarea id="reponse_<?php echo $i ?>_retroaction" class="wmax element-retro editeur suiviModif" name="item_reponse_<?php echo $i ?>_retroaction" rows="4" cols="200" placeholder="<?php echo TXT_INSCRIRE_VOTRE_RETROACTION_POSITIVE ?>"><?php echo $item->get("reponse_" . $i . "_retroaction") ?></textarea></td>
														<td class="icDelAdd">
									...
									<div id="section3" class="detailContenant nod">
										<div class="detailContenu">
											...
											<div class="wdemiGa">
												...
												<div><label for="item_couleur_element"><?php echo TXT_COULEUR_FOND_ELEMENT ?></label>
												
													<div class="menuContexte menuContexteCouleurs displayInline" >
														<?php $couleur = "element"; ?>
													    <input type="hidden" name="item_couleur_<?php echo $couleur ?>" id="item_couleur_<?php echo $couleur ?>" value="<?php echo $item->get("couleur_" . $couleur)?>" />
													    <a class="tools gras" href="#item_couleur_<?php echo $couleur ?>"><span class="carre" style="background: #<?php if ($item->get("couleur_" . $couleur) == "") echo "FFFFFF"; else echo $item->get("couleur_" . $couleur)?>" id="couleur_<?php echo $couleur ?>"></span></a>
														<?php include '../ressources/includes/menu-contexte-couleurs-damier.php' ?>
													</div>
												</div>
												
												<div><label for="item_couleur_element_associe"><?php echo TXT_COULEUR_FOND_ELEMENT_A_ASSOCIER ?></label>
									
													<div class="menuContexte menuContexteCouleurs displayInline" >
														<?php $couleur = "element_associe"; ?>
													    <input type="hidden" name="item_couleur_<?php echo $couleur ?>" id="item_couleur_<?php echo $couleur ?>" value="<?php echo $item->get("couleur_" . $couleur)?>" />
														<a class="tools gras" href="#item_couleur_<?php echo $couleur ?>"><span class="carre" style="background: #<?php if ($item->get("couleur_" . $couleur) == "") echo "FFFFFF"; else echo $item->get("couleur_" . $couleur)?>;" id="couleur_<?php echo $couleur ?>"></span></a>
														<?php include '../ressources/includes/menu-contexte-couleurs-damier.php' ?>
													</div>
												...
												<p><label for="item_afficher_masque"><?php echo TXT_TYPE_AFFICHAGE_DES_ELEMENTS_MASQUES ?></label>
													<select class="w250 suiviModif" id="item_afficher_masque" name="item_afficher_masque">
														<option value="1" <?php echo $item->get('afficher_masque_1') ?> ><?php echo TXT_MASQUES_AU_DEBUT ?></option>
														<option value="0" <?php echo $item->get('afficher_masque_0') ?> ><?php echo TXT_NON_MASQUES_AU_DEBUT ?></option>
													</select>
												</p>
												...
												<div id="cadre1" class="cadre" style="display:none;">
													...
													<table class="tblItemParam">
														<tr>
															...
															<p><label for="item_couleur_element"><?php echo TXT_COULEUR_FOND_ELEMENT ?></label>
															
																<div class="menuContexte menuContexteCouleurs displayInline" >
																	<?php $couleur = "element_quest"; ?>
																    <input type="hidden" name="item_couleur_<?php echo $couleur ?>" id="item_couleur_<?php echo $couleur ?>" value="<?php echo $item->get("couleur_" . $couleur)?>" />
																    <a class="tools gras" href="#item_couleur_<?php echo $couleur ?>"><span class="carre" style="background: #<?php if ($item->get("couleur_" . $couleur) == "") echo "FFFFFF"; else echo $item->get("couleur_" . $couleur)?>" id="couleur_<?php echo $couleur ?>"></span></a>
																	<?php include '../ressources/includes/menu-contexte-couleurs-damier.php' ?>
																</div>															
															...
															<p><label for="item_couleur_element_associe_quest"><?php echo TXT_COULEUR_FOND_ELEMENT_A_ASSOCIER ?></label>
															
																<div class="menuContexte menuContexteCouleurs displayInline" >
																	<?php $couleur = "element_associe_quest"; ?>
																    <input type="hidden" name="item_couleur_<?php echo $couleur ?>" id="item_couleur_<?php echo $couleur ?>" value="<?php echo $item->get("couleur_" . $couleur)?>" />
																    <a class="tools gras" href="#item_couleur_<?php echo $couleur ?>"><span class="carre" style="background: #<?php if ($item->get("couleur_" . $couleur) == "") echo "FFFFFF"; else echo $item->get("couleur_" . $couleur)?>" id="couleur_<?php echo $couleur ?>"></span></a>
																	<?php include '../ressources/includes/menu-contexte-couleurs-damier.php' ?>
																</div>
															...
															<p><label for="item_afficher_masque_quest"><?php echo TXT_TYPE_AFFICHAGE_DES_ELEMENTS_MASQUES ?></label>
																<select class="w250 suiviModif" id="item_afficher_masque_quest" name="item_afficher_masque_quest">
																	<option value="1" <?php echo $item->get('afficher_masque_quest_1') ?> ><?php echo TXT_MASQUES_AU_DEBUT ?></option>																
																	<option value="0" <?php echo $item->get('afficher_masque_quest_0') ?> ><?php echo TXT_NON_MASQUES_AU_DEBUT ?></option>
																</select>
															</p>																
