										...
										<div class="detailContenu">
											...
											<div class="itemType">
												...
												<div class="menuContexteGa displayInline">
													<a class="tools" href="#"><span class="txtType"><img class="alTexBot" src="../images/ic-mise-ordre.png" alt="<?php echo TXT_MISE_EN_ORDRE ?>" />&nbsp;<?php echo TXT_MISE_EN_ORDRE ?><img src="../images/ic-tools-2.png" alt="" /></span></a>
											...
											<table class="tblItemDesc margTop20" id="liste-elements">
												<tr class="titre">
													<td style="width:6%; "></td>
													<td><label class="displayInline"><?php echo TXT_ELEMENT ?> :</label> 
