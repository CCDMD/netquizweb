...
<head>
	...
	function remplacerResponsable(element) {
		...
		if (flagModifications) {
			...
			if (confirm('<?php echo TXT_NOMMER_RESPONSABLE_AVERTISSEMENT_ADMIN ?>')) {
	...
	function changerPage(page) {
		...
		if (page != pageCour) {
			urlDest = "admin.php?demande=projet_modifier&projet_page=" + page;
	...
	<div id="bodyContenu">
		...
		<div id="corps">
			...
			<div id="jqxSplitter">
				...
				<div id="colD">
					<div id="zoneContenu">
						<?php include '../ressources/includes/barre-nav-admin-projets.php' ?>
						<div id="contenu">
							<div id="contenuPrincipal">
							<div class="filAriane flGa"><h2><img src="../images/ic-projet.png" alt="<?php echo TXT_TOUS_LES_PROJETS ?>" /><a href="admin.php?demande=projets_liste"><?php echo TXT_TOUS_LES_PROJETS ?></a><span class="sep">&gt;</span> <?php echo $projet->get("titre") ?> <span class="id">(<?php echo TXT_PREFIX_PROJET . $projet->get("id_projet")?>)</span></h2></div>
                            <div class="tools menuContexteGa projetTools flDr padTo15">
                                <img src="../images/ic-tools.png" alt="" />
                                <?php include '../ressources/includes/menu-contexte-admin-projet-modifier.php' ?>
                            </div>
													...
													<tr class="tblNav">
														<td class="alCe">
															<div class="menuContexte">
																<img src="../images/ic-tools.png" alt="" />
																<?php include '../ressources/includes/menu-contexte-admin-collaborateurs-actuels.php' ?>
															</div>
														</td>
                                                        <td colspan="3"></td>
													</tr>
                                            ...
                                            <table class="tblListe tblListeCollaborateurs">
													<tr class="tblNav">
														<td class="alCe">
															<div class="menuContexte">
																<img src="../images/ic-tools.png" alt="" />
																<?php include '../ressources/includes/menu-contexte-admin-collaborateurs-invites.php' ?>
															</div>
														</td>
                                                    <td colspan="2"></td>
													</tr>
