...
// ----------------------------------------------------------------------------------------------------------
// ITEM <?php echo $item->getJS("item_index") ?> - VRAI OU FAUX
// ----------------------------------------------------------------------------------------------------------
...
page.readableType = '<?php echo $langue->getJS("item_vraioufaux") ?>';

// Consigne selon la langue du questionnaire ou de l'aperçu
page.consigne = '<?php echo $langue->getJS("consignes_vraifaux") ?>';

// Champ Pondération dans Paramètres de l'item (défaut pour vrai ou faux = 1.0)
