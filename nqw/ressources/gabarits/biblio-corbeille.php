...
<head>
	<title><?php echo TXT_NETQUIZ_WEB?> - <?php echo TXT_CORBEILLE ?></title>
...
<body id="bBCorbeille" onload="resizePanels();">
	<div id="bodyContenu">
		...
		<div id="corps">
			<div id="jqxSplitter">
				...
				<div id="colD">
					<div id="zoneContenu">
						<?php include '../ressources/includes/barre-rech-biblio-corbeille.php' ?>
						<div id="contenu">
