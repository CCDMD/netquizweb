<div class="boxApropos">
	...
	<div class="boxContenu">
		<ul>
			<li class="actif"><a href="#" onclick="javascript:changeFancybox('questionnaires.php?demande=aide_apropos_intro');"><?php echo TXT_INTRODUCTION ?></a></li>
		...
		<h1><?php echo TXT_A_PROPOS?> <span class="sep">&gt;</span> <?php echo TXT_INTRODUCTION ?></h1>
        <?php echo TXT_INTRO_LIGNE_1 ?>
