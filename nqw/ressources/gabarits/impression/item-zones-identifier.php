				...
				<p><span class="champTitre"><?php echo TXT_IMAGE ?></span>
					<br />
					<span class="champValeur"><img class="itemMediaImg" src="media.php?demande=media_afficher&media_id_media=<?php echo $item->get("image") ?>" alt="<?php echo TXT_PREFIX_MEDIA . $item->get("image") ?>" /></span></p>				
				...
				<?php
						if ($item->get("reponse_total") == "" || $item->get("reponse_total") == 0) {
							...
							for ($i =1; $i <= $item->get("reponse_total"); $i++ ) {
								...
								echo "<h5>" . TXT_ZONES_A_IDENTIFIER . " $i </h5>\n";
								...
								if ($item->get("type_elements1") == "texte") {
									...
									echo "<p><span class='champTitre'>" . TXT_REPONSE . "</span><br />\n";
