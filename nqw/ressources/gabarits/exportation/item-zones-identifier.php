  ...
  <item>
	...
	<couleur_zones><?php echo $item->getXML("couleur_zones")?></couleur_zones>
	...
	<image><?php echo $item->getXML("image")?></image>
...
<?php for ( $i = 1; $i <= $item->getJS("reponse_total"); $i++ ) { ?>
	<reponse>
		...
		<coordonnee_x><?php echo $item->getXML("reponse_" . $i . "_coordonnee_x")?></coordonnee_x>
		<coordonnee_y><?php echo $item->getXML("reponse_" . $i . "_coordonnee_y")?></coordonnee_y>
