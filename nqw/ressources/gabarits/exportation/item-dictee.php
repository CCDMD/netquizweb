  ...
  <item>
	...
	<retroaction_positive><?php echo $item->getXML("retroaction_positive")?></retroaction_positive>
	<retroaction_negative><?php echo $item->getXML("retroaction_negative")?></retroaction_negative>
	<type_item>6</type_item>		
