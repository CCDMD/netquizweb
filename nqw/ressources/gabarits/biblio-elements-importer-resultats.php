...
<head>
	...
	function recommencer() {
		document.location="bibliotheque.php?demande=elements_importer_formulaire";
	}
							...
							<div id="contenuPrincipal">
                                ...
                                <div class="detail">
                                    ...
                                    <div class="detailBot"><div>
                                        <input class="btnReset" name="btnReset" id="btnReset2" type="button" onclick="recommencer()" value="<?php echo TXT_NOUVELLE_IMPORTATION ?>"  />
									</div></div>
                                 </div>
