...
<head>
	...
	function changerPage(page) {
		...
		if (page != pageCour) {
			document.frm.demande.value="collection_liste";
	...
	<div id="bodyContenu">
		...
		<div id="corps">
			...
			<div id="jqxSplitter">
				...
				<div id="colD">
					<div id="zoneContenu">
						<?php include '../ressources/includes/barre-rech-biblio-collection.php' ?>
						<div id="contenu">
							<div id="contenuPrincipal">
						
								<div class="filAriane"><h2><img src="../images/ic-collection.png" alt="<?php echo TXT_MES_COLLECTIONS ?>" /><?php echo TXT_MES_COLLECTIONS ?><span><a class="tools" href="bibliotheque.php?demande=collection_ajouter"><?php echo TXT_AJOUTER_UNE_NOUVELLE_COLLECTION ?></a></span></h2></div>
								...
								<form id="frm" name="frm" action="bibliotheque.php" method="post">
									...
									<input type="hidden" name="demande" value="collection_liste" />
									...
									<table class="tblListe">
										<tr class="tblNav">
											<td class="alCe">
												<div class="menuContexte">
													...
													<?php include '../ressources/includes/menu-contexte-collections-liste.php' ?>
												</div>
											</td>
											<td colspan="4">
												<div class="flDr">
										...
										<tr>
											...
											<th class="cCode"><a href="#" class="<?php echo $collection->get('tri_id_collection') ?>" onclick="changerTri('id_collection')"><?php echo TXT_CODE ?></a></th>
											<th class="c3"><a href="#" class="<?php echo $collection->get('tri_titre') ?>" onclick="changerTri('titre')"><?php echo TXT_TITRE ?></a></th>
											<th class="c4"><a href="#" class="<?php echo $collection->get('tri_remarque') ?>" onclick="changerTri('remarque')"><?php echo TXT_REMARQUE ?></a></th>
											<th class="c5 last"><a href="#" class="<?php echo $collection->get('tri_date_modification') ?>" onclick="changerTri('date_modification')"><?php echo TXT_DATE_DE_MODIFICATION ?></a></th>
										</tr>
									<?php foreach($listeCollection as $element){ ?> 									
										<tr>
											<td class="cCheck"><input class="noBord selectionElement" type="checkbox" name="collections_selection_<?php echo $element->get("id_collection")?>" value="<?php echo $element->get("id_collection")?>" /></td>
											<td><?php echo $element->get("id_prefix")?></td>
											<td class="alGa"><a href="bibliotheque.php?demande=collection_modifier&collection_id_collection=<?php echo $element->get("id_collection") ?>"><?php echo $element->get("titre")?></a></td>
