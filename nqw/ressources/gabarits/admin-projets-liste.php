...
<head>
	<title><?php echo TXT_NETQUIZ_WEB_ADMIN?> - <?php echo TXT_TOUS_LES_PROJETS ?></title>
	...
	function verifierSelection() {
		...
		// Désactiver les items du menu qui ne s'appliquent pas plusieurs projets
		if (nbSel > 1) {
			$("#menuModifier").addClass("inactif");
			$("#menuTerminerCollaboration").removeClass("inactif");
			$("#menuCorbeille").removeClass("inactif");
...
<body id="bAProjets" onload="resizePanels();">
    ...
    <div id="bodyContenu">
		...
		<div id="corps">
			...
			<div id="jqxSplitter">
				...
				<div id="colD">
					<div id="zoneContenu">
						<?php include '../ressources/includes/barre-rech-admin-projets.php' ?> 
						<div id="contenu">
							<div id="contenuPrincipal">
								<div class="filAriane"><h2><img src="../images/ic-projet.png" alt="<?php echo TXT_TOUS_LES_PROJETS ?>" /><?php echo TXT_TOUS_LES_PROJETS ?><span><a class="tools" href="admin.php?demande=projet_ajouter"><?php echo TXT_AJOUTER_UN_PROJET ?></a></span></h2></div>
								<!--  Messages -->
								...
								<!--  /Messages -->	
									...
									<table class="tblListe tblListeProjets">
										<tr class="tblNav">
											<td class="alCe">
												<div class="menuContexte">
													...
													<?php include '../ressources/includes/menu-contexte-admin-projets-liste.php' ?>
												</div>
											</td>
											<td colspan="6">
												<div class="flGa">
										...
										<tr>
											...
											<th class="c7 last nowrap"><a href="#" class="<?php echo $projet->get('tri_date_modification') ?>" onclick="changerTri('date_modification')"><?php echo TXT_DATE_DE_MODIFICATION ?></a></th>
										</tr>
										...
										<?php foreach($listeProj as $proj){ ?> 
											...
											<tr>
												...
												<td><a href="admin.php?demande=projet_modifier&projet_id_projet=<?php echo $proj->get('id_projet') ?>"><?php echo $proj->get('titre') ?></a></td>
												<td><?php echo $proj->getResponsableProjet()?></td>
												<td><?php echo $proj->get('repertoire'); ?></td>
												<td><?php echo $proj->getStatutTxt() ?></td>
												<td class="last nowrap"><?php echo $proj->get('date_modification') ?></td>
											</tr>
